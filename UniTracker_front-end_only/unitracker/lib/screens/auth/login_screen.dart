  ...
  Future<void> _login() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        // Handle driver login with generated email
        String loginEmail = _emailController.text;
        if (_selectedRole == 'driver') {
          // For drivers, generate email from driver ID
          loginEmail =
              '${_driverIdController.text.toLowerCase()}@unitracker.driver';
        }
        ...
        if (mounted) {
          ...
          if (errorMsg.contains('invalid login credentials') ||
            ...
            userMessage = _selectedRole == 'driver'
