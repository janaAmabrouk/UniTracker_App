...
import 'package:unitracker/screens/profile/student_profile_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      // Ensure notification service is initialized when home screen is shown
...
class _HomeContentState extends State<HomeContent> {
  ...
  Future<void> _initializeServices() async {
    try {
      ...
      setState(() {
        _isLoading = false;
        _error = null; // Don't show error, just continue with fallback data
      });
    }
  }
